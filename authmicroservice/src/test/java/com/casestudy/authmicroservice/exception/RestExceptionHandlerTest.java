...
public class RestExceptionHandlerTest {
	...
	@Test
	public void handleUnauthorisedExceptionsTest() {
		assertEquals(restExceptionHandler.handleUnauthorizedExceptions(new UnauthorisedException(null)).getStatusCodeValue(), 400);
	}
